...
RoomListPage::RoomListPage(IGraphManager *graph, IEventManager *event, const PathFileManager &fileManager, ISoundManager *soundManager) : APage(graph, event, fileManager, soundManager)
{
...
void RoomListPage::clear()
{
	clearGUIElement(_buttons);
	clearGUIElement(_guiElement);
}

bool RoomListPage::launch()
{
	//Not implemented
	return (true);
}

void RoomListPage::draw()
{
